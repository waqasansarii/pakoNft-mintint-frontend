...
export default function Home() {
  return (
    <div className="min-h-screen h-full w-full flex flex-col  overflow-hidden">
      ...
      <header className="min-w-full text-gray-800 py-14 px-4  md:px-5">
        <div className="flex items-center container mx-auto max-w-5xl justify-between h-full">
          <Link href="#">
            <a className="font-coiny text-xl md:text-3xl font-bold text-brand-white">
              <span className="bg-gradient-to-br from-brand-green to-brand-white  pr-2 bg-clip-text">
                Bored{" "}
              </span>
              Ape
            </a>
          ...
          <nav aria-label="Contact Menu">
            <ul className="flex items-center space-x-4 md:space-x-6">
              <li className="cursor-pointer">
                <a>
                  <BsDiscord className="w-8 h-8 text-brand-white" />
                </a>
              </li>
              <li className="cursor-pointer">
                <a>
                  <FaTwitterSquare className="w-8 h-8 text-brand-white" />
                </a>
              </li>
              {/* <li className="cursor-pointer">
                <a>
      ...
      <div className="aboutSection">
        <div className="abContent">
          <div className="mnLink mb-10">
            <Link href="/mint">
              <a className="font-coiny text-xl font-bold text-brand-white py-5 px-10 rounded-lg bg-gradient-to-br from-brand-purple to-brand-pink animate-pulse">
                Go To Minting Page
              </a>
            </Link>
          </div>
          <div className="flex flex-col items-center">
            <img
              className="mt-10  rounded-lg h-80"
              src="https://img-s1.onedio.com/id-624ead38e37476c216b2ac6b/rev-0/w-620/f-jpg/s-ff1cf6479409c5b23a919be96e6ec3ce731faa7c.jpg"
            />
            <h2 className="font-coiny text-3xl uppercase font-bold text-brand-purple mt-10">
              About BoredApe
            </h2>
            <p className="max-w-2xl mt-5   font-coiny text-xl text-brand-white">
              Non-fungible tokens can digitally represent any asset, including
              online-only assets like digital artwork and real assets such as
              real estate. Other examples of the assets that NFTs can represent
              include in-game items like avatars, digital and non-digital
              collectibles, domain names, and event tickets.
            </p>
          </div>
        </div>
      </div>
